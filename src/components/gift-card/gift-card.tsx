    ...
    <Card className={`${styles.card}${full ? ` ${styles.full}` : ""}`} elevation={Elevation.FOUR}>
      ...
      <div className={styles["card-body"]}>
        ...
        <H5 className={styles.desc}>
          Donec faucibus, ante ut ultrices commodo, magna ex maximus, sodales neque dolor vitae
          arcu. Nam euismod, neque quis laoreet interdum. Sed magna est, dictum at faucibus.
        </H5>
